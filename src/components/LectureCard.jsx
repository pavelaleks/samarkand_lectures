        ...
        {isOpen && (
          ...
          >
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {lecture.materials.map((material, idx) => (
                      ...
                      >
                        <svg className="w-8 h-8 text-purple-600 dark:text-purple-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clipRule="evenodd" />
                        </svg>
                        <span className="flex-1 text-sm sm:text-base font-medium text-gray-800 dark:text-gray-200 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                          {material.displayName || material.fileName}
                        </span>
                        <svg className="w-5 h-5 text-purple-600 dark:text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                        </svg>
                      </a>
                    ))}
              ...
              {!lecture.gammaUrl && (!lecture.materials || lecture.materials.length === 0) && (
